-- Fix scheduler_reschedule_all_parallel_aware: Remove non-existent priority column references
-- Restore correct FIFO ordering using proof_approved_at
...
BEGIN
  ...
  -- 4) Rebuild schedule with correct FIFO ordering
