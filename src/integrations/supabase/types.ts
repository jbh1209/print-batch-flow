...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      ...
      export_scheduler_input: { Args: { p_division?: string }; Returns: Json } | { Args: never; Returns: Json };
      find_available_gaps: {
        Args: {
          p_align_at?: string;
      ...
      is_admin: { Args: never; Returns: boolean } | { Args: { _user_id: string }; Returns: boolean };
      is_admin_secure_fixed: { Args: never; Returns: boolean } | { Args: { _user_id: string }; Returns: boolean };
      ...
      is_user_admin: { Args: { check_user_id?: string }; Returns: boolean } | { Args: never; Returns: boolean };
    ...
    Enums: {
      batch_status: "pending" | "processing" | "completed" | "cancelled" | "sent_to_print";
      ...
      page_status: "queued" | "batched" | "completed" | "cancelled" | "sent_to_print";
      paper_type: "Matt" | "Gloss";
      printer_type: "HP 12000" | "HP 7900";
      production_status: "Pre-Press" | "Printing" | "Finishing" | "Packaging" | "Shipped" | "Completed";
