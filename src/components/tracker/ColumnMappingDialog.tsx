...
export const ColumnMappingDialog: React.FC<ColumnMappingDialogProps> = ({
  ...
  const getValidationStatus = () => {
    ...
    const mappedCount = Object.values(mapping).filter(index => index !== -1).length;
    
    return {
      isValid: missingRequired.length === 0,
      missingRequired,
      mappedCount,
      totalFields: FIELD_DEFINITIONS.length
    };
  };
      ...
      <DialogContent className="max-w-6xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <Card>
              <CardHeader className="pb-2">
                <CardTitle className="text-sm">Fields Mapped</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="text-2xl font-bold">{validation.mappedCount}</div>
                <div className="text-sm text-muted-foreground">of {validation.totalFields} fields</div>
              </CardContent>
            </Card>
          </div>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Map each database field to the corresponding Excel column
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Table>
