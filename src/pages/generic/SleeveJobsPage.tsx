...
const SleeveJobsPage = () => {
  ...
  console.log(`[SleeveJobsPage] Rendering with key: ${renderKey}`);
  ...
  const jobsHookWrapper = () => {
    ...
    console.log(`[SleeveJobsPage] Hook wrapper executed, jobs: ${hookResult.jobs.length}`);
