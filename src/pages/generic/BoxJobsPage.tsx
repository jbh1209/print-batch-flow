...
const BoxJobsPage = () => {
  ...
  console.log(`[BoxJobsPage] Rendering with key: ${renderKey}`);
  ...
  const jobsHookWrapper = () => {
    ...
    console.log(`[BoxJobsPage] Hook wrapper executed, jobs: ${hookResult.jobs.length}`);
