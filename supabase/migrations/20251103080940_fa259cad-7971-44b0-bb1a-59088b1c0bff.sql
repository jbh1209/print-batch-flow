-- Fix scheduler to use the correct function name: place_duration_business_hours
...
BEGIN
  ...
  LOOP
    ...
    -- Calculate placement using correct function
    SELECT calculated_start_time, calculated_end_time 
