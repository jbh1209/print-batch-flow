-- Restore October 24th working version of trigger function for manual proof approvals
-- This function was inadvertently simplified in recent migrations, losing critical logging and error handling
...
DECLARE
  ...
  v_error_msg text;
BEGIN
  -- Check if proof_approved_at was just set (from NULL to NOT NULL)
