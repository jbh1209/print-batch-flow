-- Fix scheduler_resource_fill_optimized to properly use part-aware _stage_tails
-- This migration corrects the seeding, querying, and updating of the part-aware temporary table
...
BEGIN
  ...
  -- Get base time (next working day start)
  SELECT public.next_working_start(now() AT TIME ZONE 'Africa/Johannesburg', 'Africa/Johannesburg')
  INTO base_time;
