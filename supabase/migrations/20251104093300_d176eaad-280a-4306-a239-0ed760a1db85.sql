-- FIFO Fix: Remove resource_available_time from Phase 1 stage_earliest_start calculation
-- This ensures strict FIFO ordering based on proof_approved_at during Phase 1
-- Line 461 change: Comment out GREATEST(stage_earliest_start, resource_available_time)
