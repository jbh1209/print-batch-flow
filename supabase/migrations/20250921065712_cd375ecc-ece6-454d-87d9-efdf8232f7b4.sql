-- Drop existing function and recreate with enhanced return type
DROP FUNCTION IF EXISTS get_job_hp12000_stages(UUID);

-- Recreate HP12000 stages function with part assignments and specifications  
