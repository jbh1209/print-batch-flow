-- Fix Phase 2 gap-filling propagation by adding multi-pass convergence
-- This ensures that when a predecessor stage moves earlier, dependent stages
-- can also move earlier in the same scheduler run.
