-- Fix nested aggregate error in scheduler_reschedule_all_parallel_aware
-- Replace completed_barriers assignment block with subquery pattern to avoid nested aggregates
-- CRITICAL: This migration ONLY changes the completed_barriers block (lines 87-101)
-- CRITICAL: All other logic including the FIFO enforcement comment remains EXACTLY as-is
...
BEGIN
  ...
  -- ========== FIXED: Replace nested aggregate with subquery pattern ==========
  completed_barriers := (
