-- Fix the clear function to set is_rework = true when resetting overdue active stages
...
BEGIN
  ...
  -- STEP 1: Reset overdue active stages to pending (FIXED: added is_rework = true)
  -- These are stages that should have completed but are still marked as active
  UPDATE job_stage_instances
  SET 
    status = 'pending',
    is_rework = true,  -- CRITICAL FIX: Bypass prevent_concurrent_stage_changes trigger
    started_at = NULL,
    started_by = NULL,
