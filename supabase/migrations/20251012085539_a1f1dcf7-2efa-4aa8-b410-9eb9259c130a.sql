-- Surgical update to scheduler_reschedule_all_parallel_aware: Add conflict-safe slot insertion
-- This prevents duplicate key violations by skipping conflicting slots and deriving times from actual inserts
