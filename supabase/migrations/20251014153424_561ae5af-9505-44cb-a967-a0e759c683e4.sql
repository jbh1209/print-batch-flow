-- Fix part-aware parallel processing: Text/Cover stages should not wait for each other
-- This restores the logic from 20250922135534 migration that was lost in subsequent updates

-- ============================================================================
-- 1. Update scheduler_reschedule_all_parallel_aware (Gap-Filling Phase)
-- ============================================================================
...
-- ============================================================================
-- 2. Update scheduler_append_jobs (Main Scheduling Phase)
-- ============================================================================
