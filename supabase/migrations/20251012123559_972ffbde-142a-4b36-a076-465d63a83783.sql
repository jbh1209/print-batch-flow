-- Fix scheduler_append_jobs to enforce ALL-OR-NOTHING atomic scheduling per job
-- with proper stage precedence and part barriers
...
BEGIN
  ...
  -- Initialize resource availability from completed slots
