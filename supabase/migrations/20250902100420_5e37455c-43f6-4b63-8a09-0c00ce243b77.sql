-- Fix the scheduler functions to remove explicit date column setting
-- Let the existing triggers automatically populate the date column
  ...
  LOOP
    ...
    LOOP
      ...
      LOOP
        ...
        -- Insert time slot (removed explicit date column - let trigger handle it)
