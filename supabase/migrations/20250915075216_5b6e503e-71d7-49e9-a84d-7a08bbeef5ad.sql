-- Fix simple_scheduler_wrapper to route reschedule_all to the sequential scheduler
...
BEGIN
  CASE p_mode
    WHEN 'reschedule_all' THEN
      -- Use the PROPERLY FIXED sequential scheduler that honors stage dependencies
