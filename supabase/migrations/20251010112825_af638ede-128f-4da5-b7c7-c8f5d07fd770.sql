-- Fix nested aggregate usage in completed_barriers within scheduler_reschedule_all_parallel_aware
...
BEGIN
  ...
  -- FIXED: compute per-job MAX() first, then aggregate to JSON to avoid nested aggregates
  completed_barriers := (
