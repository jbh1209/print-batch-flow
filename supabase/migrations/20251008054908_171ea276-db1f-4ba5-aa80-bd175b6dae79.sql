-- Fix scheduler to reschedule active and on_hold stages
-- Only clears schedule data for on_hold stages, keeps active stages as baseline
...
BEGIN
  ...
  RAISE NOTICE 'Cleared scheduling data from on_hold stages (active stages keep baseline)';
