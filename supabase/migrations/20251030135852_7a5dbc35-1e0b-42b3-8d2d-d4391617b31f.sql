-- Restore overlap protection to gap-filling phase
-- Prevents jobs from overlapping on the same resource by adding range-based overlap detection
...
BEGIN
  ...
  FROM public.validate_schedule() v;
