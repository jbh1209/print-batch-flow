-- Restore October precedence check for Phase 2 gap-filling
-- Prevents stages from starting before their predecessors complete
...
DECLARE
  ...
  days_saved numeric;
  predecessor_end timestamptz; -- Added for precedence check
