-- ============================================================
-- FIX: Correct permission check in get_dashboard_job_stats
-- ============================================================
-- Problem: Function references non-existent 'permission_type' column
-- Solution: Use 'can_manage' boolean column instead
-- ============================================================
...
AS $function$
BEGIN
  -- Simple permission check: user must have 'can_manage = true' on at least one stage
