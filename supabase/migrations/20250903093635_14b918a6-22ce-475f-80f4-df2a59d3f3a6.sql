-- Phase 1: Data Integrity Fixes and Enhanced Scheduler with Parallel Support

-- First, let's audit the current job stage instances to understand the data issues
...
-- Add constraint to prevent malformed stage sequences within same job
-- (Allow same stage_order for different parts, but ensure consistency)
