-- Fix scheduler to only process proof-approved jobs and clean up duplicate slots (recreate view)

-- Step 1: Drop and recreate v_scheduler_stages_ready view with proof approval filter
