-- Fix scheduler to use correct placement function
-- The place_stage_duration_v2 doesn't exist - should use place_duration_in_working_time
...
BEGIN
  ...
  LOOP
    ...
    -- Calculate placement for this stage using the correct function
    SELECT start_time, end_time INTO placement_start, placement_end
