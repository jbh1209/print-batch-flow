-- Enhanced scheduler to fix data inconsistency between job_stage_instances and stage_time_slots
-- This ensures UI shows correct times and eliminates false violations
...
BEGIN
  ...
  RAISE NOTICE 'ENHANCED Sequential Scheduler COMPLETE: % slots written, % instances updated, % violations remain', 
