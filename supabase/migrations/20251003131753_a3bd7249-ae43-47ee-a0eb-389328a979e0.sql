-- Update scheduler_reschedule_all_parallel_aware to respect remaining_minutes for held stages
    ...
    LOOP
      ...
      FOR r_stage IN
        SELECT 
          ...
          jsi.status,
          -- UPDATED: Pass remaining_minutes to jsi_minutes for held stages
