-- Patch: Replace jsonb_object_length() with COUNT(jsonb_object_keys()) in scheduler_reschedule_all_sequential_fixed_v2
...
BEGIN
  ...
  RAISE NOTICE 'STAGE-FIFO V3: Pre-seeded part barriers for % jobs', job_part_barriers_count;
