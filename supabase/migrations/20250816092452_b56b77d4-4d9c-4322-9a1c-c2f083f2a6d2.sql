-- STEP 3: Unified Schema Migration (Complete function cleanup)

-- Drop ALL validation and check functions with CASCADE
...
DROP FUNCTION IF EXISTS check_user_is_admin(uuid) CASCADE;
DROP FUNCTION IF EXISTS check_user_admin_status(uuid) CASCADE;
