-- Fix jsonb_object_keys scalar context error in scheduler_reschedule_all_sequential_fixed_v2
...
BEGIN
  ...
  -- FIXED: Use jsonb_object_length instead of jsonb_object_keys for scalar context
  RAISE NOTICE 'STAGE-FIFO V3: Pre-seeded part barriers for % jobs', COALESCE(jsonb_object_length(job_part_barriers), 0);
