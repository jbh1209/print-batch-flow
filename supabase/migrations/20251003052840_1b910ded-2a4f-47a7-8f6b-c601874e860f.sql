-- Fix find_available_gaps() function - resolve ambiguous column references
-- by renaming PL/pgSQL variables and using table aliases
...
BEGIN
  ...
  WHILE current_day < p_fifo_start_time::date LOOP
    ...
    -- Get shift windows for this day - use alias to avoid ambiguous column references
    SELECT 
