-- Restore exact Oct 24 working scheduler functions from docs/db dump
...
DROP FUNCTION IF EXISTS public.simple_scheduler_wrapper();
...
-- 2) Recreate exact Oct 24 working version: scheduler_reschedule_all_parallel_aware(p_start_from timestamptz DEFAULT NULL)
...
-- 3) Recreate exact Oct 24 working version: simple_scheduler_wrapper(p_mode text DEFAULT 'reschedule_all', p_start_from timestamptz DEFAULT NULL)
