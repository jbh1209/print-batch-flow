-- Fix the upsert_excel_mapping function to resolve type mismatch error
...
DECLARE
  ...
  conflict_count integer := 0;  -- Separate integer variable for count
...
BEGIN
  ...
  ELSE
    ...
    had_conflict := conflict_count > 0;  -- Proper boolean assignment
