-- Restore simple_scheduler_wrapper to call the robust parallel-aware scheduler
-- and revert scheduler_reschedule_all_parallel_aware to the working version

-- First, fix the wrapper to use the parallel-aware scheduler
...
BEGIN
  ...
  CASE p_mode
    WHEN 'reschedule_all' THEN
      -- Use the robust parallel-aware scheduler with dependency groups and part barriers
...
-- Now restore the robust parallel-aware scheduler from migration 20250905152210
