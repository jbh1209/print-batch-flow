-- Simple fix for scheduler: restore working day scheduling with FIFO ordering
-- Simplified approach to avoid SQL syntax conflicts

-- Drop and recreate with simpler logic
DROP FUNCTION IF EXISTS public.scheduler_reschedule_all_parallel_aware();

-- Create a simplified scheduler that respects working hours and FIFO ordering
