-- Drop and recreate the clear function with enhanced overdue handling
...
BEGIN
  ...
  RAISE NOTICE 'SCHEDULER CLEANUP: Starting cleanup at %', current_time;
  ...
  WHERE status = 'active'
    ...
    AND scheduled_end_at < current_time - interval '1 hour'; -- Give 1 hour grace period
