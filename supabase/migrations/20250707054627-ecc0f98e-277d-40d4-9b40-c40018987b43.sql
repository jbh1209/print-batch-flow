-- Fix get_user_accessible_jobs_with_conditional_stages function to prevent duplicate job records
-- This function should return single records for regular jobs and multiple only for concurrent multi-part jobs
