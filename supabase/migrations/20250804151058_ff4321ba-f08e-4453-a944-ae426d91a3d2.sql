...
-- Create new unique constraint that includes part_name
ALTER TABLE public.production_job_schedules 
ADD CONSTRAINT production_job_schedules_unique_schedule 
UNIQUE (job_id, job_table_name, production_stage_id, scheduled_date, COALESCE(part_name, ''));
