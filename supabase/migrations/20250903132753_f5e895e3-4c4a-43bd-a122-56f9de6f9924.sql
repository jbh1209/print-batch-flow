-- Fix parallel processing scheduler to handle completed stages and barrier logic correctly
...
BEGIN
  ...
  LOOP
    ...
    SELECT jsonb_object_agg(
      ...
      COALESCE(jsi.scheduled_end_at, GREATEST(base_time, r_job.proof_approved_at))
