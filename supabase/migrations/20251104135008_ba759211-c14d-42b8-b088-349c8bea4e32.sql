-- Fix completed_barriers timing: capture BEFORE nuclear wipe
-- Problem: completed_barriers was queried AFTER DELETE, returning empty results
-- Solution: Move completed_barriers query to BEFORE the DELETE statement
