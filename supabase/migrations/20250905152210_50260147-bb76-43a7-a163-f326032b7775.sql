-- Increase scheduling horizon from 30 to 60 days to allow longer-term scheduling

-- Update place_duration_sql to use 60-day default horizon
CREATE OR REPLACE FUNCTION public.place_duration_sql(p_earliest_start timestamp with time zone, p_duration_minutes integer, p_max_days integer DEFAULT 60)
...
-- Update parallel-aware scheduler to explicitly use 60-day horizon
