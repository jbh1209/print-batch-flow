-- SURGICAL FIX: Add part_assignment to _stage_tails operations in scheduler_append_jobs
-- Fixes 4 specific locations: 2 INSERTs, 1 SELECT, 1 UPDATE
...
BEGIN
  ...
  -- FIX #1: Include part_assignment in first INSERT
  ...
  GROUP BY sts.production_stage_id, sts.part_assignment
  ON CONFLICT (stage_id, part_assignment) DO UPDATE SET
    next_available_time = GREATEST(EXCLUDED.next_available_time, _stage_tails.next_available_time);

  -- FIX #2: Include part_assignment in second INSERT
  INSERT INTO _stage_tails(stage_id, part_assignment, next_available_time)
  ...
  LOOP
    ...
    LOOP
      ...
      LOOP
        ...
        -- FIX #3: Include part_assignment in SELECT WHERE clause
        ...
        -- FIX #4: Include part_assignment in UPDATE WHERE clause
        UPDATE _stage_tails 
...
COMMENT ON FUNCTION public.scheduler_append_jobs IS 'Fixed: _stage_tails operations now include part_assignment to match composite PK (stage_id, part_assignment) - 4 surgical changes applied';