-- Rebuild gap-filling mechanism to use place_duration_sql() for proper multi-day splitting
-- This fixes the issues where gap-filled stages were manually placed without proper validation
...
BEGIN
  ...
  -- PHASE 2: GAP-FILLING WITH place_duration_sql() (FIXED)
