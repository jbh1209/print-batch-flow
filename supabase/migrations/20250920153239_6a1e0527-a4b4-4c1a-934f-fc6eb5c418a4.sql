-- Fix critical database function overloads - restore proper job deduplication
...
-- Recreate get_user_accessible_jobs with proper CTE structure to show one job per entry
...
-- Recreate get_user_accessible_jobs_with_batch_allocation with proper CTE structure
