-- Restore proper working day/shift scheduling logic while keeping FIFO ordering
-- This fixes the scheduler that was broken by removing working day boundaries

-- First verify we have the helper functions needed
