-- Add PROOF/DTP/Batch stage filtering to scheduler_append_jobs
-- This prevents manual proof approval and job appending from scheduling non-production stages
...
-- Clean up legacy PROOF stage with scheduled times from before filtering was implemented
UPDATE job_stage_instances
SET 
  ...
  updated_at = now()
WHERE id = '5e7bb8a2-e1de-44bd-ac0a-69d7ef04683b';