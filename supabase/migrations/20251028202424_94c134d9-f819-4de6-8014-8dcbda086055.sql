-- RESTORE PROVEN WORKING SCHEDULER FROM OCTOBER 12TH, 2024
-- This migration restores the scheduler functions that were working correctly before division awareness was added
-- Division awareness will be added in a future migration AFTER this is verified to work

-- ============================================================================
-- RESTORE: scheduler_reschedule_all_parallel_aware
-- This is the proven working scheduler with proper sequential barriers and gap-filling
-- ============================================================================
...
BEGIN
  ...
  FOR pass_iteration IN 1..3 LOOP
    ...
    -- Exit early if no stages moved in this pass
